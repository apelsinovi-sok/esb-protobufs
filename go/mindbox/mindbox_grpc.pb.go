...
const (
	Mailing_Partnership_FullMethodName = "/mindbox.Mailing/Partnership"
)
...
type MailingClient interface {
	Partnership(ctx context.Context, in *PartnershipRequest, opts ...grpc.CallOption) (*PartnershipResponse, error)
}
...
func (c *mailingClient) Partnership(ctx context.Context, in *PartnershipRequest, opts ...grpc.CallOption) (*PartnershipResponse, error) {
	out := new(PartnershipResponse)
	err := c.cc.Invoke(ctx, Mailing_Partnership_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedMailingServer
// for forward compatibility
type MailingServer interface {
	Partnership(context.Context, *PartnershipRequest) (*PartnershipResponse, error)
}

// UnimplementedMailingServer should be embedded to have forward compatible implementations.
type UnimplementedMailingServer struct {
}

func (UnimplementedMailingServer) Partnership(context.Context, *PartnershipRequest) (*PartnershipResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Partnership not implemented")
}
...
func _Mailing_Partnership_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PartnershipRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MailingServer).Partnership(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Mailing_Partnership_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MailingServer).Partnership(ctx, req.(*PartnershipRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Mailing_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mindbox.Mailing",
	HandlerType: (*MailingServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Partnership",
			Handler:    _Mailing_Partnership_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/mindbox.proto",
